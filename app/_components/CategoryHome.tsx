            ...
            <div className="flex flex-col gap-4">
                ...
                {category.category_type === "artists" ? (
                    <div className="flex flex-row overflow-x-hidden gap-4">
                        {category.category_artists_saved_id.slice(0, 6).map((cat) => {
                    ...
                    <div className="flex flex-row overflow-x-hidden gap-4">
                        {category.category_artists_id.slice(0, 6).map((cat) => {
                ...
                {category.category_type === "albums" ? (
                    <div className="flex flex-row overflow-x-hidden gap-1">
                        {category.category_albums_saved_id.slice(0, 6).map((cat) => {
                    ...
                    <div className="flex flex-row overflow-x-hidden gap-1">
                        {category.category_albums_id.slice(0, 6).map((cat) => {
                ...
                {category.category_type === "tracks" ? (
                    <div className="flex flex-row w-full overflow-x-hidden gap-1">
                        {category.category_tracks_saved_id.slice(0, 6).map((cat) => {
                    ...
                    <div className="flex flex-row overflow-x-hidden gap-1">
                        {category.category_tracks_id.slice(0, 6).map((cat) => {
                            const findAlbumsImage = albums?.find(album => (album.album_tracks_id ?? []).includes(cat));
                ...
                {category.category_type === "playlists" ? (
                    <div className="flex flex-row overflow-x-hidden gap-1">
                        {category.category_playlists_saved_id.slice(0, 6).map((cat) => {
                    ...
                    <div className="flex flex-row overflow-x-hidden gap-1">
                        {category.category_playlists_id.slice(0, 6).map((cat) => {
